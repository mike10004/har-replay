...
package io.github.mike10004.vhs.repackaged.org.apache.http.util;
...
public final class CharArrayBuffer implements CharSequence, Serializable {
    ...
    public CharArrayBuffer(final int capacity) {
        super();
        if (capacity < 0) {
            throw new IllegalArgumentException("buffer capacity must be nonnegative");
        }
