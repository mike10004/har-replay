...
public class ContentDisposition {
    ...
    private static String encodeHeaderFieldParam(String input, Charset charset) {
        java.util.Objects.requireNonNull(input, "Input String should not be null");
        java.util.Objects.requireNonNull(charset, "Charset should not be null");
    ...
    private static class BuilderImpl implements Builder {
        ...
        public BuilderImpl(String type) {
            checkArgument(!Strings.isNullOrEmpty(type), "'type' must not be not empty");
            this.type = type;
        }
