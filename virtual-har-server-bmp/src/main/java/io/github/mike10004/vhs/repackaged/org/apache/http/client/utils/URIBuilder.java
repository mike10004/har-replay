 ...
 * @since 4.2
 */
@SuppressWarnings({"unused", "Java8CollectionRemoveIf", "UseBulkOperation", "Convert2Diamond", "ManualArrayToCollectionCopy"})
public class URIBuilder {
    ...
    private List <NameValuePair> parseQuery(final String query, final Charset charset) {
        if (query != null && !query.isEmpty()) {
            return URLEncodedUtils.parseToNameValuePairs(query, charset);
        }
        return null;
    }
    ...
    public URIBuilder setQuery(final String query) {
        this.queryParams = parseQuery(query, this.charset != null ? this.charset : StandardCharsets.UTF_8);
        this.query = null;
        this.encodedQuery = null;
        this.encodedSchemeSpecificPart = null;
        return this;
    ...
    public URIBuilder addParameter(final String param, final String value) {
        ...
        this.queryParams.add(NameValuePair.of(param, value));
        this.encodedQuery = null;
        this.encodedSchemeSpecificPart = null;
        this.query = null;
        return this;
